...
import 'package:cotton_app/representation/ui/admin/ui/postScreen.dart';
...
class AdminServices {
  void sellProduct({
    ...
    try {
      final cloudinary = CloudinaryPublic('dntow8p6j', 'xptaq655');
    ...
    try {
      ...
      httpErrorHandle(
        ...
        onSuccess: () {
          ...
          sales = [
            Sales('Cambric', response['cambricEarnings']),
            Sales('Poplin', response['poplinEarnings']),
            Sales('Lawn', response['lawnEarnings']),
            Sales('Organic', response['organicEarnings']),
